(defun nm/quick-capture ()
  "Start a capture template using the quick capture template."
  (interactive)
  (org-capture nil "!"))
(bind-key "<f9>" 'nm/quick-capture)
(bind-key "<f12>" 'org-cycle-agenda-files)

;; [[file:../../../tmp/config.org.1ke6yV::*company mode][company mode:1]]
(after! org
  (set-company-backend! 'org-mode 'company-capf '(company-yasnippet company-org-roam company-elisp))
  (setq company-idle-delay 0.25))
;; company mode:1 ends here

;; [[file:../../../tmp/config.org.1ke6yV::*Misc Modules \[Bookmarks, PDF Tools\]][Misc Modules [Bookmarks, PDF Tools]:1]]
;(use-package org-pdftools
;  :hook (org-load . org-pdftools-setup-link))
;; Misc Modules [Bookmarks, PDF Tools]:1 ends here

;; [[file:../../../tmp/config.org.1ke6yV::*Graphs and Chart Modules][Graphs and Chart Modules:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Elfeed][Elfeed:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*DEFT][DEFT:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*DEFT][DEFT:2]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Org-Rifle][Org-Rifle:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Pandoc][Pandoc:1]]
(setq org-pandoc-options '((standalone . t) (self-contained . t)))
;; Pandoc:1 ends here

;; [[file:../../../tmp/config.org.1ke6yV::*ROAM][ROAM:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*ROAM Server][ROAM Server:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*ROAM Export Backlinks + Content][ROAM Export Backlinks + Content:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Reveal \[HTML Presentations\]][Reveal [HTML Presentations]:1]]
(require 'ox-reveal)
(setq org-reveal-root "https://cdn.jsdelivr.net/npm/reveal.js")
(setq org-reveal-title-slide nil)
;; Reveal [HTML Presentations]:1 ends here

;; [[file:../../../tmp/config.org.1ke6yV::*Super Agenda Settings][Super Agenda Settings:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Custom Functions][Custom Functions:1]]
;(load! "customs.el")
(load! "org-helpers.el")
;; Custom Functions:1 ends here

;; [[file:../../../tmp/config.org.1ke6yV::*Time Stamps][Time Stamps:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Capture Template File Picker][Capture Template File Picker:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Clarify Tasks][Clarify Tasks:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Capture headline finder][Capture headline finder:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Search file headlines and send tree to indirect buffer][Search file headlines and send tree to indirect buffer:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*Change Font][Change Font:1]]
...
;; [[file:../../../tmp/config.org.1ke6yV::*End of file loading][End of file loading:1]]
