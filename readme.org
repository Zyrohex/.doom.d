What I would like to implement eventually...

* Agenda
** TODO Better suited for GTD
** TODO [[https://github.com/Malabarba/org-agenda-property][Agenda properties]]
** DONE Project oriented agenda
CLOSED: [2019-12-16 Mon 20:13]
:LOGBOOK:
- Note taken on [2019-12-16 Mon 20:13] \\
  For now this is done, by using :auto-parent t
- State "DONE"       from "TODO"       [2019-12-16 Mon 20:13]
:END:
* Charts & Diagrams
** TODO Gnuplot
* Emails
...
* Passwords
** TODO Keep records of passwords in emacs
* Modules
** TODO [[https://github.com/millejoh/emacs-ipython-notebook][iPython]]
* Interesting modules or snippets
** Agenda start day current day
#+BEGIN_SRC emacs-lisp
(setq org-agenda-start-day (org-today))
#+END_SRC
** Agenda string for header level
#+BEGIN_EXAMPLE
